...
class UI:
    ...
    def banner():
        banner = f'''
    {Fore.LIGHTBLACK_EX}https://discord.gg/SwmF2xVaCt{Style.RESET_ALL}
    \t\t\t    ██╗  ██╗     ██████╗ ██████╗  ██████╗ ██╗  ██╗██╗   ██╗
    \t\t\t    ╚██╗██╔╝     ██╔══██╗██╔══██╗██╔═══██╗╚██╗██╔╝╚██╗ ██╔╝
    \t\t\t     ╚███╔╝█████╗██████╔╝██████╔╝██║   ██║ ╚███╔╝  ╚████╔╝ 
    \t\t\t     ██╔██╗╚════╝██╔═══╝ ██╔══██╗██║   ██║ ██╔██╗   ╚██╔╝  
    \t\t\t    ██╔╝ ██╗     ██║     ██║  ██║╚██████╔╝██╔╝ ██╗   ██║   
    \t\t\t    ╚═╝  ╚═╝     ╚═╝     ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝   ╚═╝  
    \t\t\t                                            {Fore.LIGHTBLACK_EX}by t01ru#5528{Style.RESET_ALL}
    '''
        return banner
...
def main():
    x = UI()
    p = ProxyScrape()
    system('title X-Proxy by t01ru#5528 ^| AIO Proxy Tool')
    system('cls')
